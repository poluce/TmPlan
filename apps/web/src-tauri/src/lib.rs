...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            fs_commands::read_import_metadata,
            fs_commands::query_events,
            fs_commands::write_project,
            fs_commands::write_module,
            fs_commands::write_decision,
            fs_commands::update_task_status,
            fs_commands::append_import_metadata,
            fs_commands::remove_stale_module_files,
            fs_commands::remove_stale_decision_files,
